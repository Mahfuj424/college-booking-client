  ...
  return (
    <div className="container">
      <form
        ...
        className="bg-[#52FFBF] my-10 p-5 rounded-xl shadow-md"
      >
        ...
        <div className="mb-4">
          <label htmlFor="CollegeDetails" className="block mb-2">
            University Details:
          </label>
          <textarea
            defaultValue={college_Details}
            readOnly
            name="CollegeDetails"
            id="CollegeDetails"
            rows="4"
        ...
        <div className="mb-4 text-center">
          <button type="submit" className="px-4 py-2 bg-white text-black rounded-md w-full">
            Submit
          </button>
        </div>
      </form>
