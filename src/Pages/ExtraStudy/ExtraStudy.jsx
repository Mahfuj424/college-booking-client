            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:ms-0 ms-8">
                <p className="text-4xl text-gray-800">
                  <span className="text-5xl font-bold ">Courses From The</span>{" "}
                  World’s <br /> Leading Experts
                </p>
              ...
              <div className="grid mx-auto grid-cols-2 gap-5">
                ...
                <div className="border bg-white rounded-lg w-36 h-36 flex items-center justify-center">
                  <div>
                    ...
                    <h2 className="absolute  text-lg text-black ">
                      Technology
                    </h2>
                  </div>
                </div>
                <div className="border bg-white rounded-lg w-36 h-36 flex items-center justify-center">
                  <div>
                    <AiOutlineRead className="w-20 h-20" />
                    <h2 className="absolute  text-lg text-black ">Humanity</h2>
                  </div>
                </div>
                <div className="border bg-white rounded-lg w-36 h-36 flex items-center justify-center">
                  <div>
                    <PiHandbagBold className="w-20 h-20" />
