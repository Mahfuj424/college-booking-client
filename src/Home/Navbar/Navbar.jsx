...
const Navbar = () => {
     ...
     <p className='text-lg hover:text-cyan-500 transition-all'><NavLink className={({ isActive }) => isActive ? 'border-b-2 pb-2 text-cyan-500 border-cyan-500' : ''} to='/admission'>Admission </NavLink></p>
